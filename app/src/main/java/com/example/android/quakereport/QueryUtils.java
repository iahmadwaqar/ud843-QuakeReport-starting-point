    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                JSONObject jsonObjectAtIndex = jsonArray.getJSONObject(i);
                JSONObject propertyJsonObject = jsonObjectAtIndex.getJSONObject("properties");
